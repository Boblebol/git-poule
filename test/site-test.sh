...
assert_contains "404.html" "Page introuvable"
assert_contains "legal.html" "Mentions Légales"
assert_contains "robots.txt" "Sitemap:"
assert_contains "sitemap.xml" "https://boblebol.github.io/git-poule/"
